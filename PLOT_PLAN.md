...
| K3b | SNN accuracy vs **measured cycle-to-cycle σ** (RR-8b), 15-level vs usable-level grid | `fig_k3_variability.py c2c` + `raw/c2c_per_level.csv` | **DONE** — `K3b_accuracy_vs_c2c.{png,csv}`; σ=0.0215 dec (11 repeats) costs 0.001 accuracy; the 8-level "usable" grid costs 0.036 |
