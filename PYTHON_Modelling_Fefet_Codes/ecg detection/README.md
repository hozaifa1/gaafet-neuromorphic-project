...
| `fig_k3_variability.py` | **K3a/K3b/K3c** accuracy vs variability | d2d shifts a device's whole ladder — write-verify recovers it exactly (0.830); the measured c2c σ = 0.022 dec costs 0.001. Level *overlap* and *separability* do not predict accuracy; per-device level misplacement does |
