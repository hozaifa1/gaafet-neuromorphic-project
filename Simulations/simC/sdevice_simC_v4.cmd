*===================================================================
*== PHASE 1B — SIM C v4: FINE VPULSE SWEEP FOR GRADUAL INTEGRATION
*== v3 showed 3V fires near P1, 4-5V fires ON P1.
*== v4 sweeps lower Vpulse (1.5, 2.0, 2.5V) to find multi-pulse fire.
*== Sweep: @Vpulse@ = 1.5, 2.0, 2.5 V  (SWB nodes)
*== Fixed: VGS_read=0.2V, VDS=0.05V, Vreset=-6.0V, pw=1us
