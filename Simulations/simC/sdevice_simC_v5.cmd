*===================================================================
*== PHASE 1B — SIM C v5: SHORT PULSE + HIGH VPULSE FOR GRADUAL LIF
*== v3/v4 showed pw/tau_E=1 saturates in 3 pulses.
*== v5: pw=100ns (pw/tau_E=0.1) → ~10% switching per pulse.
*== Sweep: @Vpulse@ = 3.0, 4.0, 5.0 V  (SWB nodes)
*== Fixed: VGS_read=0.2V, VDS=0.05V, Vreset=-4.0V, pw=100ns
*== Protocol: 20 write-then-read cycles, 5us leak gap after P10
...
Solve {
  ...
  *=== PULSE TRAIN: 20 write-then-read cycles ===
  * pw=100ns, Vpulse=@Vpulse@, VGS_read=0.2V
  * 5us leak gap after pulse 10
  ...
  *=== LEAK GAP: 5us at VGS_read=0.2V ===
  ...
  Transient (
    InitialTime=2.1200e-06 FinalTime=7.1200e-06
    InitialStep=1e-10 MaxStep=50e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(2.1200e-06 7.1200e-06) Intervals=50) )
  }

  *--- PULSE 11 ---
  NewCurrentPrefix="p11_rise_"
  Transient (
    InitialTime=7.1200e-06 FinalTime=7.1210e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= @Vpulse@ }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.1200e-06 7.1210e-06) Intervals=5) )
  }
  NewCurrentPrefix="p11_write_"
  Transient (
    InitialTime=7.1210e-06 FinalTime=7.2210e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.1210e-06 7.2210e-06) Intervals=10) )
  }
  NewCurrentPrefix="p11_fall_"
  Transient (
    InitialTime=7.2210e-06 FinalTime=7.2220e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 0.2 }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.2210e-06 7.2220e-06) Intervals=5) )
  }
  NewCurrentPrefix="p11_read_"
  Transient (
    InitialTime=7.2220e-06 FinalTime=7.3220e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.2220e-06 7.3220e-06) Intervals=20) )
  }

  *--- PULSE 12 ---
  NewCurrentPrefix="p12_rise_"
  Transient (
    InitialTime=7.3220e-06 FinalTime=7.3230e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= @Vpulse@ }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.3220e-06 7.3230e-06) Intervals=5) )
  }
  NewCurrentPrefix="p12_write_"
  Transient (
    InitialTime=7.3230e-06 FinalTime=7.4230e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.3230e-06 7.4230e-06) Intervals=10) )
  }
  NewCurrentPrefix="p12_fall_"
  Transient (
    InitialTime=7.4230e-06 FinalTime=7.4240e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 0.2 }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.4230e-06 7.4240e-06) Intervals=5) )
  }
  NewCurrentPrefix="p12_read_"
  Transient (
    InitialTime=7.4240e-06 FinalTime=7.5240e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.4240e-06 7.5240e-06) Intervals=20) )
  }

  *--- PULSE 13 ---
  NewCurrentPrefix="p13_rise_"
  Transient (
    InitialTime=7.5240e-06 FinalTime=7.5250e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= @Vpulse@ }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.5240e-06 7.5250e-06) Intervals=5) )
  }
  NewCurrentPrefix="p13_write_"
  Transient (
    InitialTime=7.5250e-06 FinalTime=7.6250e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.5250e-06 7.6250e-06) Intervals=10) )
  }
  NewCurrentPrefix="p13_fall_"
  Transient (
    InitialTime=7.6250e-06 FinalTime=7.6260e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 0.2 }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.6250e-06 7.6260e-06) Intervals=5) )
  }
  NewCurrentPrefix="p13_read_"
  Transient (
    InitialTime=7.6260e-06 FinalTime=7.7260e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.6260e-06 7.7260e-06) Intervals=20) )
  }

  *--- PULSE 14 ---
  NewCurrentPrefix="p14_rise_"
  Transient (
    InitialTime=7.7260e-06 FinalTime=7.7270e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= @Vpulse@ }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.7260e-06 7.7270e-06) Intervals=5) )
  }
  NewCurrentPrefix="p14_write_"
  Transient (
    InitialTime=7.7270e-06 FinalTime=7.8270e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.7270e-06 7.8270e-06) Intervals=10) )
  }
  NewCurrentPrefix="p14_fall_"
  Transient (
    InitialTime=7.8270e-06 FinalTime=7.8280e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 0.2 }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.8270e-06 7.8280e-06) Intervals=5) )
  }
  NewCurrentPrefix="p14_read_"
  Transient (
    InitialTime=7.8280e-06 FinalTime=7.9280e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.8280e-06 7.9280e-06) Intervals=20) )
  }

  *--- PULSE 15 ---
  NewCurrentPrefix="p15_rise_"
  Transient (
    InitialTime=7.9280e-06 FinalTime=7.9290e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= @Vpulse@ }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.9280e-06 7.9290e-06) Intervals=5) )
  }
  NewCurrentPrefix="p15_write_"
  Transient (
    InitialTime=7.9290e-06 FinalTime=8.0290e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(7.9290e-06 8.0290e-06) Intervals=10) )
  }
  NewCurrentPrefix="p15_fall_"
  Transient (
    InitialTime=8.0290e-06 FinalTime=8.0300e-06
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 0.2 }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(8.0290e-06 8.0300e-06) Intervals=5) )
  }
  NewCurrentPrefix="p15_read_"
  Transient (
    InitialTime=8.0300e-06 FinalTime=8.1300e-06
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(8.0300e-06 8.1300e-06) Intervals=20) )
  }
  ...
  *=== RESET PULSE (Vreset=-4.0V) ===
  ...
  Transient (
    InitialTime=9.1410e-06 FinalTime=1.0141e-05
    InitialStep=1e-10 MaxStep=10e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(9.1410e-06 1.0141e-05) Intervals=20) )
  }
  NewCurrentPrefix="reset_fall_"
  Transient (
    InitialTime=1.0141e-05 FinalTime=1.0142e-05
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 0.2 }
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(1.0141e-05 1.0142e-05) Intervals=5) )
  }

  *=== POST-RESET READ ===
  NewCurrentPrefix="postreset_read_"
  Transient (
    InitialTime=1.0142e-05 FinalTime=1.0242e-05
    InitialStep=1e-11 MaxStep=5e-9 MinStep=1e-15
    Increment=1.4
  ) {
      Coupled (Iterations = 100) {Poisson Electron Hole}
      CurrentPlot( Time = (Range=(1.0142e-05 1.0242e-05) Intervals=20) )
  }
