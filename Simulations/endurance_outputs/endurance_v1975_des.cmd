...
*==   (a) 9 program pulses at V_pgm=1.975 V (100ns hold, 100ns sub-Vt read)
...
File {
    ...
    Plot       = "endurance_outputs/endurance_v1975_des.tdr"
    Current    = "endurance_outputs/endurance_v1975_des.plt"
    Output     = "endurance_outputs/endurance_v1975_des.log"
}
...
Solve {
  ...
  *====================================================================
  ...
  Transient (
    ...
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 1.975 }
  ) { Coupled (Iterations = 100) {Poisson Electron Hole} }
