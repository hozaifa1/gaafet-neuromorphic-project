...
*==   (a) 9 program pulses at V_pgm=2.025 V (100ns hold, 100ns sub-Vt read)
...
File {
    ...
    Plot       = "endurance_outputs/endurance_v2025_des.tdr"
    Current    = "endurance_outputs/endurance_v2025_des.plt"
    Output     = "endurance_outputs/endurance_v2025_des.log"
}
...
Solve {
  ...
  *====================================================================
  ...
  Transient (
    ...
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 2.025 }
  ) { Coupled (Iterations = 100) {Poisson Electron Hole} }
