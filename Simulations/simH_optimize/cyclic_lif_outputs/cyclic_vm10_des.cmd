...
File {
    ...
    Plot       = "cyclic_lif_outputs/cyclic_vm10_des.tdr"
    Current    = "cyclic_lif_outputs/cyclic_vm10_des.plt"
    Output     = "cyclic_lif_outputs/cyclic_vm10_des.log"
}
...
Solve {
  ...
  *--- CYCLE 1 ERASE (rise / 10 us hold / fall) ---
  ...
  Transient (
    ...
    InitialStep=1e-3 MaxStep=5e-2 MinStep=1e-7
    Increment=1.4
    Goal { Name="gate_contact" Voltage= -10.0 }
  ) { Coupled (Iterations = 100) {Poisson Electron Hole} }
