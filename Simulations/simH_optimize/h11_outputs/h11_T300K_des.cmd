*===================================================================
*== PHASE 1D - H11 CROSS-TEMPERATURE, T = 300 K
*==
*== 3 cycles at V_pgm = 2.0 V, V_erase = -6 V, T = 300 K.
*==
*== Suite:
...
File {
    ...
    Plot       = "h11_outputs/h11_T300K_des.tdr"
    Current    = "h11_outputs/h11_T300K_des.plt"
    Output     = "h11_outputs/h11_T300K_des.log"
}
