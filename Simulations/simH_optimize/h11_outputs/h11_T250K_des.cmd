*===================================================================
*== PHASE 1D - H11 CROSS-TEMPERATURE, T = 250 K
*==
*== 3 cycles at V_pgm = 2.0 V, V_erase = -6 V, T = 250 K.
*==
*== Suite:
...
File {
    ...
    Plot       = "h11_outputs/h11_T250K_des.tdr"
    Current    = "h11_outputs/h11_T250K_des.plt"
    Output     = "h11_outputs/h11_T250K_des.log"
}
