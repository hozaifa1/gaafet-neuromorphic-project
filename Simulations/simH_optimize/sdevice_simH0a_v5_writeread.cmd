*===================================================================
*== PHASE 1D — SIM H0a v5: TASNEEM-PROTOCOL I_D-V_G READ
*== Reference: Tasneem 2022 IEEE TED Fig 3(b)/(c)
*==
*== v5 changes vs v4 (v4 achieved MW=1.4 V, but post-PGM V_t=-1.22 V
*== was too close to v4 read floor -1.5 V to extract SS cleanly):
*==   - Read window: -1.5 V -> +1.0 V replaced with -2.0 V -> +1.0 V
*==     (still sub-coercive at gate, V_c,gate = 1.91 V; gives ~0.78 V
*==     of subthreshold span below post-PGM V_t for clean log-linear
*==     SS fit)
*==   - Everything else identical to v4 (10 us pulses, ±4 V).
*==
*== Sequence:
*==   0. Init Poisson
