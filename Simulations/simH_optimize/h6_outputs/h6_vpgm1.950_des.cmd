...
*== SWB sweep: 1.950 in {1.95, 1.975, 2.0, 2.025, 2.05} V
*===================================================================

File {
    Grid       = "n1_msh.tdr"
    Parameter  = "sdevice_gaafet_lif.par"
    Plot       = "h6_outputs/h6_vpgm1.950_des.tdr"
    Current    = "h6_outputs/h6_vpgm1.950_des.plt"
    Output     = "h6_outputs/h6_vpgm1.950_des.log"
}
...
Solve {
  ...
  *====================================================================
  ...
  Transient (
    ...
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 1.950 }
  ) { Coupled (Iterations = 100) {Poisson Electron Hole} }
