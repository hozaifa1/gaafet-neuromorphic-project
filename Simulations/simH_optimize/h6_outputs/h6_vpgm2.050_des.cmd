...
*== SWB sweep: 2.050 in {1.95, 1.975, 2.0, 2.025, 2.05} V
*===================================================================

File {
    Grid       = "n1_msh.tdr"
    Parameter  = "sdevice_gaafet_lif.par"
    Plot       = "h6_outputs/h6_vpgm2.050_des.tdr"
    Current    = "h6_outputs/h6_vpgm2.050_des.plt"
    Output     = "h6_outputs/h6_vpgm2.050_des.log"
}
...
Solve {
  ...
  *====================================================================
  ...
  Transient (
    ...
    Increment=1.4
    Goal { Name="gate_contact" Voltage= 2.050 }
  ) { Coupled (Iterations = 100) {Poisson Electron Hole} }
