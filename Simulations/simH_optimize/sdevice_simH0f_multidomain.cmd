*===================================================================
*== PHASE 1D - H0f MULTI-DOMAIN PREISACH (NumberOfDomains = 40)
*==
*== PRECONDITION: sdevice_gaafet_lif.par must have
*==     FerroelectricPolarization (NumberOfDomains = 40)
*==
*== Output: cycle-to-cycle dispersion within a single V_pgm node ->
*== device-intrinsic M8 sigma/mu (vs current deterministic coupling).
*== Per cycle = 81.838 us | 3 cycles
*===================================================================
