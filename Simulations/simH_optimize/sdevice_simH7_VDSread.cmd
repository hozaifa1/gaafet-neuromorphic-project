*===================================================================
*== PHASE 1D - H7 V_DS_READ SCALING SWEEP
*==
*== CANCELLED 2026-05-21 -- DO NOT RUN.
*== H6 (deferred-read run) established that the read segment is
*== < 0.1 fJ/pulse (0.06 % of pulse energy).  Scaling V_DS from
*== 50 mV to 10 mV saves at most ~0.06 fJ/pulse.  The dominant cost
*== is the 100 ns write hold at V_pgm = 2.0 V (126.7 fJ/pulse, 99.1
*== % of pulse energy).  See Writing_Materials/Phase1D_Analysis/
*== Energy/H6_deferred_read.md for the falsification details.
*== Cmd retained for record only.  If a V_DS robustness datapoint
*== is needed for reviewer response, run a single node (10 mV).
*==
*== V_pgm = 2.0 V locked; V_DS swept by SWB.  3 cycles per node.
*== Per cycle = 81.838 us  |  total 245.514 us
*== SWB sweep: @V_DS@ in {0.010, 0.020, 0.030, 0.050} V (L4)
*===================================================================
